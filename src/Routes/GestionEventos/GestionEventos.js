...
import ModalTablaInscritos from './ModalTablaInscritos';
...
const GestionEventos = () => {
  ...
  const [mostrarModalInscritos, setMostrarModalInscritos] = useState(false)
  ...
  return (
    <div>
      ...
      <TablaEventos
        ...
        mostrarModalInscritos={mostrarModalInscritos}
        setMostrarModalInscritos={setMostrarModalInscritos}
      />
      ...
      {
        mostrarModalInscritos == true
          ? <ModalTablaInscritos
            mostrarModal={mostrarModalInscritos}
            setMostrarModal={setMostrarModalInscritos}
            eventoSeleccionado={eventoSeleccionado}
          />
          : null
      }
