...
import {
    ObtenerEstudiantesEventoReducer
} from '../../Redux/Actions/MisCertificados/MisCertificados'

const ModalEstudiantesEvento = (props) => {
    ...
    useEffect(() => {
        dispatch(ObtenerEstudiantesEventoReducer(eventoSeleccionado))
    }, [])
...
export default ModalEstudiantesEvento