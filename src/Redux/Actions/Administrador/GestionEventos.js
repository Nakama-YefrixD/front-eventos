...
export const EditarEventoReducer = (evento) => async ( dispatch ) => {

    let dat_registrar = {}

    await fetch(config.api+'administrador/editar-evento',
        {
            mode:'cors',
            method: 'POST',
            headers: {
...
export const EliminarItemListaFechasEventosReducer = (pos) => async ( dispatch, getState ) =>  {
...
export const AgregarEventoReducer = (evento, archivo) => async (dispatch, getState) => {
...
export const ObtenerFechasEventosReducer = (evento) => async (dispatch) => {
...
export const ObtenerPonentesEventosReducer = (evento) => async (dispatch) => {
